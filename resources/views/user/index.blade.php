                    ...
                    <div class="card card-left1 mb-4">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" >
                                    <li><a class="dropdown-item btn btn-outline-info " href="{{route('background.image')}}">Add</a></li>
                        ...
                        <div class="card-body text-center ">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" >
                                        ...
                                        <li><a class="dropdown-item btn btn-outline-info " href="{{route('profile.imageEdit')}}">Edit</a></li>
                                        <li><a class="dropdown-item btn btn-outline-info " href="#">Delete</a></li>
