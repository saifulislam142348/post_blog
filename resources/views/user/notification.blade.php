...
<nav class="navbar navbar-expand-md navbar-dark" style="background-color:#3097D1">
    <a href="index.html" class="navbar-brand"><img src="img/brand-white.png" alt="logo" class="img-fluid" width="80px"
            height="100px"></a>
    ...
    <div class="collapse navbar-collapse" id="responsive">
        <ul class="navbar-nav mr-auto text-capitalize">
            <ul class="navbar-nav mr-auto text-capitalize">
                ...
                <li class="nav-item"><a href="#" class="nav-link" data-toggle="modal">messages</a></li>
                <li class="nav-item"><a href="{{route('notification')}}" class="nav-link">post</a></li>
            ...
            <div class="middle-column">
                <div class="card shadow-sm">
                    ...
                    <div class="media d -flex justify-content-between">
                        <p class="mt-2"> <i class="fas fa-globe-americas mx-2"></i><span class="h5 mr-2"><a
                                    href="#" class="text-info">Dave Gamache</a></span>went traveling </p>
                    ...
                    <div class="media d -flex justify-content-between">
                        <p> <i class="fas fa-gamepad mx-1"></i> <span class="h5 mr-2"> <a href="#"
                                    class="text-info"> Mark Otto</a></span>played destiny</p>
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <p> <span class="h5 mr-2"> <a href="#" class="text-info"> Fat and 1
                                        other</a></span>followed you</p>
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <p class="h5 mr-2"> <span> <a href="#" class="text-info"> Dave Gamache</a></span>
                                uploaded a photo</p>
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <p class="h5 mr-2"> <span> <a href="#" class="text-info"> Mark Otto </a></span>
                                Flagged your post</p>
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <p> <span class="h5 mr-2"> <a href="#" class="text-info"> Mark otto and 2
                                        other</a></span>favourite your post</p>
                            <img src="img/avatar-dhg.png" alt="" width="40px" height="40px"
                                class="rounded-circle img-fluid">
                            <img src="img/avatar-fat.jpg" alt="" width="40px" height="40px"
                                class="rounded-circle img-fluid">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <p><span class="h5"> <a href="#" class="text-info"> Fat and 1 other
                                    </a></span>followed you</p>
                                ...
                                <div class="col-12 col-lg-6 mb-3 mb-lg-0">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body text-center">
                                            <img src="img/avatar-dhg.png" alt="" width="75px"
                                                height="75px" class="rounded-circle img-fluid mt-n5">

                                            <h5 class="card-title">Jacob thunder</h5>
                                            <p class="card-text text-justify">Lorem ipsum dolor sit amet, consectetur
                                                adipisicing elit. Suscipit, totam!</p>
                                ...
                                <div class="col-12 col-lg-6">
                                    ...
                                    <div class="card">
                                        <img src="img/left2.jpg" alt="" class="card-img-top" width="200px"
                                            height="155px">
                                        <div class="card-body text-center">
                                            <img src="img/avatar-fat.jpg" alt="" width="75px"
                                                height="75px" class="rounded-circle img-fluid mt-n5">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <p> <span class="h5 mr-2"> <a href="#" class="text-info"> Jack and 1
                                        other</a></span>update their settings</p>
                            <img src="img/avatar-dhg.png" alt="" width="40px" height="40px"
                                class="rounded-circle img-fluid">
                            <img src="img/avatar-fat.jpg" alt="" width="40px" height="40px"
                                class="rounded-circle img-fluid">
